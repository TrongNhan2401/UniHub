...
namespace Application.Features.Interfaces
{
    public interface IWorkshopService
    {
        ...
        Task<Result<PagedResult<WorkshopListDto>>> GetWorkshopsPagedAsync(int pageNumber, int pageSize, DateTime? date = null, string? status = null, string? sortByTime = null, bool includeDrafts = false);
        Task<Result<WorkshopDetailDto>> GetWorkshopDetailAsync(Guid id, bool includeDrafts = false);
    }
}
