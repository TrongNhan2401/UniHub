        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomMapUrl = table.Column<string>(type: "text", nullable: true),
                    ...
                    AiSummaryGeneratedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrToken = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSyncedFromOffline = table.Column<bool>(type: "boolean", nullable: false),
                    OfflineDeviceId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_UserId_WorkshopId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrations_UserId_WorkshopId",
                table: "Registrations",
                columns: new[] { "UserId", "WorkshopId" },
                unique: true);
