...
export default function DashboardScreen() {
  ...
  const openScanner = () => {
    ...
    if (parent) { parent.navigate("Scan"); return }
        ...
        <TouchableOpacity style={s.scanBtn} onPress={openScanner} activeOpacity={0.85}>
          <View style={s.scanBtnInner}>
            ...
            <View style={{ marginLeft: 14 }}>
              ...
              <Text style={{ color: "rgba(255,255,255,0.75)", fontSize: 13, marginTop: 2 }}>Tap to open camera scanner</Text>
            </View>
          </View>
...
const s = StyleSheet.create({
  ...
  scanBtn: {
    ...
    shadowColor: "#2563eb", shadowOpacity: 0.35, shadowRadius: 12, elevation: 5,
  },
